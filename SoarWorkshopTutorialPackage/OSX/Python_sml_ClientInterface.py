...
class Agent_Info(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, Agent_Info, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, Agent_Info, name)
    __repr__ = _swig_repr
    __swig_setmethods__["soarAgentSML"] = _Python_sml_ClientInterface.Agent_Info_soarAgentSML_set
    __swig_getmethods__["soarAgentSML"] = _Python_sml_ClientInterface.Agent_Info_soarAgentSML_get
    if _newclass:soarAgentSML = _swig_property(_Python_sml_ClientInterface.Agent_Info_soarAgentSML_get, _Python_sml_ClientInterface.Agent_Info_soarAgentSML_set)
    def __init__(self): 
        this = _Python_sml_ClientInterface.new_Agent_Info()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _Python_sml_ClientInterface.delete_Agent_Info
    __del__ = lambda self : None;
Agent_Info_swigregister = _Python_sml_ClientInterface.Agent_Info_swigregister
Agent_Info_swigregister(Agent_Info)

class cmp_str(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, cmp_str, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, cmp_str, name)
    __repr__ = _swig_repr
    def __call__(self, *args): return _Python_sml_ClientInterface.cmp_str___call__(self, *args)
    def __init__(self): 
        this = _Python_sml_ClientInterface.new_cmp_str()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _Python_sml_ClientInterface.delete_cmp_str
    __del__ = lambda self : None;
cmp_str_swigregister = _Python_sml_ClientInterface.cmp_str_swigregister
cmp_str_swigregister(cmp_str)
...
class Soar_Instance(_object):
    ...
    def Get_Default_Agent(self): return _Python_sml_ClientInterface.Soar_Instance_Get_Default_Agent(self)
    ...
    def Get_Soar_AgentSML(self, *args): return _Python_sml_ClientInterface.Soar_Instance_Get_Soar_AgentSML(self, *args)
