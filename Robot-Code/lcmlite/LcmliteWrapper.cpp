...
int LcmliteWrapper::init(){
  ...
  struct sockaddr_in read_addr;
	...
	read_addr.sin_port = htons(MC_PORT);
  ...
  // Sending Socket
	...
	send_addr.sin_addr.s_addr = inet_addr(MC_ADDR);
	send_addr.sin_port = htons(MC_PORT);
